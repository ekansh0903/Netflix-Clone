...
const SearchHistoryPage = () => {
	...
	useEffect(() => {
		const getSearchHistory = async () => {
			try {
				const res = await axios.get(`https://netflix-clone-vdcs.onrender.com/api/v1/search/history`);
	...
	const handleDelete = async (entry) => {
		try {
			await axios.delete(`https://netflix-clone-vdcs.onrender.com/api/v1/search/history/${entry.id}`);
